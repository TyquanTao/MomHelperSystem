...
public class ImgController {
     ...
     * @return
     */
    @GetMapping("admin/findAdminByConditions")
    @ApiOperation(value = "条件查询管理员", notes = "此方法是超级管理员可操作的接口")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", name = "size", value = "第几页", required = true, dataType = "int"),
            @ApiImplicitParam(paramType = "query", name = "sizePage", value = "一页多少条", required = true, dataType = "int")
    })
     ...
     * @return
     */
    @PostMapping("admin/findAdminById")
    @ApiOperation(value = "根据管理员Id查找管理员", notes = "此方法是超级管理员可操作的接口")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", name = "size", value = "第几页", required = true, dataType = "int"),
            @ApiImplicitParam(paramType = "query", name = "sizePage", value = "一页多少条", required = true, dataType = "int")
    })
